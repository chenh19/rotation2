...
**Aim:** In this section, I'll perform naive negative binomial regression with and without total UMI as a covariate. This is mainly to check whether the negative controls have inflated p-values.
