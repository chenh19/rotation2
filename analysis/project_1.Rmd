...
**Code:** [```QC_filter_2.R```](https://raw.githubusercontent.com/chenh19/rotation2/main/code/4_filter/QC_filter_2.R)  
**Code:** [```UMI_plot_2.R```](https://raw.githubusercontent.com/chenh19/rotation2/main/code/4_filter/UMI_plot_2.R)  
...
[```QC_by_author.txt```](https://raw.githubusercontent.com/chenh19/rotation2/main/output/QC/QC_by_author.txt)  
[```QC_by_hang_2.txt```](https://raw.githubusercontent.com/chenh19/rotation2/main/output/QC/QC_by_hang_2.txt)  
