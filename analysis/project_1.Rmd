...
1. Is the small values in the previous PDF plot wrong?
...
Plotted with package:

```{r,eval=FALSE}
EnvStats::epdfPlot(barcode_dist, epdf.col = "red")
```

![4](https://raw.githubusercontent.com/chenh19/rotation2/main/output/QC/4_Expression_barcode_dist_qc_pdf(EnvStats_epdfPlot))  
