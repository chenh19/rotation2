...
**Code:** [```zero-flated.R```](https://raw.githubusercontent.com/chenh19/rotation2/main/code/5_zero-flated/zero-flated.R)  

![1](https://raw.githubusercontent.com/chenh19/rotation2/main/output/Zero-flated/1_zero_proportions(Poisson).png)  
![2](https://raw.githubusercontent.com/chenh19/rotation2/main/output/Zero-flated/2_zero_proportions(negative_binomial).png)  
