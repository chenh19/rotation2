...
- However, after taking a closer look at the converted gene lists, there are still many "Mitochondrially Encoded" genes starting with "MT" rather than "MT-", so I wrote the below script to convert all these genes.
- Then I performed filtering again and got 14,675 cells with 3,917 median genes per cell.
- I don't think we'll know exactly how the authors filtered the cells, but I think I'll stick to my manually converted gene list.

- For HTO, 14,626 cells were found, and then 9,401 singlets were determined
- After GDO filtering, there were 9,391 cells retained (9,343 cells by the authors in comparison)
