...
**Comment:** The highest expressed gene is *WDR45-like (WDR45L) pseudogene* (high UMI counts in all cells)  

![](https://raw.githubusercontent.com/chenh19/rotation2/main/output/Expression/6_Expression_max_target.png)  

**Comment:** The lowest expressed gene is *RP4-669L17.1 pseudogene* (zero UMI counts in all cells)  
